...
def get_sent(sender: str) -> None:
    """
    Retrieves sent mail for a sender by making a GET request to the /mail/sent/<sender> endpoint.
    
    Args:
        sender (str): The sender whose sent mail to retrieve
    
    Returns:
        None: Prints the sent mail contents to stdout
    """
...
def get_mail(mail_id: str) -> None:
    """
    Retrieves a specific mail entry by making a GET request to the /mail/<mail_id> endpoint.
    
    Args:
        mail_id (str): The unique ID of the mail entry to retrieve
    
    Returns:
        None: Prints the mail entry contents to stdout
    """
...
def delete_mail(mail_id: str) -> None:
    """
    Deletes a mail entry by making a DELETE request to the /mail/<mail_id> endpoint.
    
    Args:
        mail_id (str): The unique ID of the mail entry to delete
    
    Returns:
        None: Prints the deletion result to stdout
    """
